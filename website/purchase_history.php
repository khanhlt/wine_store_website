		...
		<div class="login">
			<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                ...
                // get time
										...
										$cur_time =$row[timetz];
                //////
										$query= "insert into order_product values (".$id_detail.",'".$_SESSION["sacc_name"]."',".$total_cost.",'".$cur_date."','".$cur_time."',false,'".$_POST['addre']."',false);";
										$result = pg_query($query); 
                ...
                //header("location: http://localhost/btl_Hai/home_guest.php");
										...
										$query = "SELECT * FROM order_product where acc_name='$name' ORDER BY order_id desc";
                                        $result = pg_query($query);

										echo "<table style = 'width:80%'>";
										echo "<center><caption> <h2 align='center'>Lịch sử mua hàng</center><br><br><font size=3>Khách hàng $row1[full_name]</font><br><br></h2></caption>";
										echo "<tr>";
										echo "<th>ID</th>";
										echo "<th>Sản phẩm</th>";
										echo "<th>Tổng số tiền(vnđ)</th>";
										echo "<th>Ngày mua</th>";
										echo "<th>Giờ mua</th>";
										echo "</tr>";
